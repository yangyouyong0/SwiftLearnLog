...
struct Five100px {
    ...
    enum Router: URLRequestConvertible {
        ...
        static let consumerKey = "V9X5a6IBNPELMd6Af5aWTVodK2itnz1ljbf5sPnH"
        ...
        var URLRequest: NSURLRequest {
            let (path: String , parameters: [String: AnyObject]) = {
                ...
                case .PhotoInfo(let photoID, let imageSize):
                    var params = ["consumer_key":Router.consumerKey,
                                    "image_size":"\(imageSize.rawValue)"]
                    return ("/photos/\(photoID)",params)
                
                case .Comments(let photoID, let commetsPage):
                    var params = ["consumer_key":Router.consumerKey,
                                      "comments":"1",
                                 "comments_page":"\(commetsPage)"]
